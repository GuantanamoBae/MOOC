...
//        The counter also has an optional check that prevents the counter from going below 0. The class has to have the following constructors:
...
//        public void increase(int increaseAmount) increases the value by the amount of the parameter.
